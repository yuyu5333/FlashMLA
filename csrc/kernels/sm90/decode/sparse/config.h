...
// V3.2 and V3.2-no-RoPE share a KV cache layout: fp8 NoPE dims followed by 4 inline fp32 scales (then, for V3.2, the bf16 RoPE part)
static constexpr bool IS_V32_LIKE = MODEL_TYPE == ModelType::V32 || MODEL_TYPE == ModelType::V32_NO_ROPE;
...
static constexpr int QUANT_TILE_SIZE = IS_V32_LIKE ? 128 : 64;
static constexpr int NUM_SCALES = IS_V32_LIKE ? 4 : 8;  // For DeepSeek-V4: 7 fp8_e4m3 + 1 padding
